...
//Power On sequence //
    ...
    _delay_ms(5); // Dis-charge capacitor power voltage
...
// ----------- Adjust the Gamma Curve ----------//
    ...
    LCD_WR_REG(0x0036,0x0206);
    LCD_WR_REG(0x0037,0x0202);
    LCD_WR_REG(0x0038,0x0202);
    LCD_WR_REG(0x0039,0x0206);
...
void LCD_write_english_string(unsigned int x,unsigned int y,char *s,unsigned int color,unsigned int xcolor)//英文字符串显示
{
    unsigned int k=0;
    while (*s)
    {
